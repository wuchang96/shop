        ...
        <form action="/admin/goods/{{$goodsone->id}}" method='post' class="mws-form" enctype='multipart/form-data'>
            <div class="mws-form-inline">
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <select name='c_id' class="small">
                            ...
                            <option value='{{$v->id}}' @if($v->id == $goodsone->c_id) selected @endif>{{$v->title}}</option>
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="text" class="small" name='stock' value='{{$goodsone->color}}'>
                    </div>
                </div>
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="text" class="small" name='stock' value='{{$goodsone->stock}}'>
                    </div>
                </div>
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                       <script id="editor" name='descr' type="text/plain" style="width:1000px;height:300px;">{!!$goodsone->descr!!}</script>
                    </div>
                </div>
