        ...
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_1_wrapper">
			<form action="/admin/user" method='get'>
                <div id="DataTables_Table_1_length" class="dataTables_length">
                    <label>
                        ...
                        <select name="num" size="1" aria-controls="DataTables_Table_1">
                            <option value="5" @if($req->num == 5)   selected="selected" @endif>
                                5
                            </option>
                            <option value="10" @if($req->num == 10)   selected="selected" @endif>
                                10
                            </option>
                            <option value="15" @if($req->num == 15)   selected="selected" @endif>
                                15
                            </option>                            
                        </select>
                        条数据
                ...
                <div class="dataTables_filter" id="DataTables_Table_1_filter">
                    <label>
                        用户名:
                        <input type="text" name='search' value="{{$req->search}}" aria-controls="DataTables_Table_1">
                    </label>

                    <label>
                        邮箱:
                        <input type="text" name='email' value="{{$req->email}}" aria-controls="DataTables_Table_1">
                    </label>
            ...
            aria-describedby="DataTables_Table_1_info">
                <thead>
                    <tr role="row">
                        ...
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                        rowspan="1" colspan="1" style="width: 170px;" aria-label="CSS grade: activate to sort column ascending">
                           操作
                        </th>
                    </tr>
                </thead>
                <tbody role="alert" aria-live="polite" aria-relevant="all">
                    ...
                    <tr class="@if($k % 2 == 1)  odd   @else even  @endif">
                        ...
                        <td class=" ">
                            <img src="{{$v->header}}" alt="" width='100'>
                            
                        </td>
                        <td class=" ">

                            {{date('Y-m-d',$v->register_at)}}
