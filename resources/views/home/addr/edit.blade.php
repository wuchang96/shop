            ...
            <table border="0" class="add_tab" style="width:930px;"  cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td colspan="3" style="font-family:'宋体';">
                  ...
                  <div class="info">
                      <div>
                        <select id="s_province" value="{{$str['0']}}" name="s_province">{{$str['0']}}</select>  
                        <select id="s_city" value="{{$str['1']}}" name="s_city" >{{$str['1']}}</select>  
                        <select id="s_county" value="{{$str['2']}}" name="s_county">{{$str['2']}}</select>（必填）</div>
              ...
              <tr>
                ...
                <td style="font-family:'宋体';"><input type="text" name="tel" value="{{$data['tel']}}" class="add_ipt" />（必填）</td>
              </tr>
              <tr>
                <td align="right">详细地址</td>
                <td style="font-family:'宋体';"><input type="text" name="addr" value="{{$str['3']}}" class="add_ipt" />（必填）</td>
                <td align="right">邮政编码</td>
                <td style="font-family:'宋体';"><input type="text" name="zip" value="{{$data['zip']}}" class="add_ipt" /></td>
              </tr>
            </table>
           	<p align="right">
