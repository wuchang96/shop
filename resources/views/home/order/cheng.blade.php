            ...
            <table border="0" style="width:1000px; text-align:center;" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td style="font-size:14px; font-family:'宋体'; padding:10px 0 20px 0; border-bottom:1px solid #b6b6b6;">
                	您选定的配送方式为: <font color="#ff4e00">申通快递</font>&nbsp; &nbsp;您的付款金额为: <font color="#ff4e00">￥{{$order['sum']}}</font>
                </td>
              </tr>
              <tr>
                <td style="font-size:10px; padding:20px 0 30px 0; font-family:'宋体';">
                    收货人：<font color="#ff4e00">{{$order['name']}}</font>
                    电话：<font color="#ff4e00">{{$order['tel']}}</font><br />
                    地址: <font color="#ff4e00">{{$order['addr']}}</font>
                </td>
              </tr>
              <tr>
                <td>
